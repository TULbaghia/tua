...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        changeVisibility: async (ratingId: number, visibility: any, options: any = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/ratings/{ratingId}/{visibility}`
        ...
        /**
         * 
         * @param {UpdateBoxDto} [body] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        updateBox: async (body?: UpdateBoxDto, options: any = {}): Promise<RequestArgs> => {
            const localVarPath = `/boxes`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        getBox(id: number, options?: any): AxiosPromise<any> {
