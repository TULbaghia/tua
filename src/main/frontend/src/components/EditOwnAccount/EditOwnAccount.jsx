...
function EditOwnAccount() {
    ...
    const handleEmailSubmit = (values, setSubmitting) => {
        handleRecaptcha(() => {dispatchDialog({
            callbackOnSave: () => {
                                ...
                                <Formik
                                    ...
                                    {({isSubmitting, handleChange}) => (
                                        <Form className={{alignItems: "center"}}>
                                            ...
                                            <FieldComponent type="password" name="oldPassword" placeholder={i18n.t('oldPassword')}
                                                            handleChange={handleChange}/>
                                            <FieldComponent type="password" name="newPassword" placeholder={i18n.t('newPassword')}
                                                            handleChange={handleChange}/>
                                ...
                                <Formik
                                    ...
                                    {({isSubmitting, handleChange}) => (
                                        <Form className={{alignItems: "center"}}>
                                            ...
                                            <FieldComponent type="text" name="name" placeholder={i18n.t('name')}
                                                            handleChange={handleChange}/>
                                            <FieldComponent type="text" name="surname" placeholder={i18n.t('surname')}
                                                            handleChange={handleChange}/>
